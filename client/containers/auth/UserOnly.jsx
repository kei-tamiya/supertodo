...
import { deleteTodoIfPossible, changeTodoTitle, updateTodoIfPossible } from '../../actions/Todo.jsx';
      ...
      <div className="row">
        ...
        <div className="col-sm-4">
          ...
          {isTodosEmpty
            ...
            : <TodoList todos={todos} deleteTodo={this.deleteTodo} changeTodoTitle={this.changeTodoTitle} updateTodo={this.updateTodo} />
          }
        </div>
      </div>
    );
